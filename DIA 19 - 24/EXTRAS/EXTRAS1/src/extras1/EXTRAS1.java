...
ecuación con los métodos obtenerRaices() o obtenerRaiz(), según lo que devuelvan nuestros métodos y en caso de no existir solución, 
...
public class EXTRAS1 {
    ...
    public static void main(String[] args) {
        ...
        Raices Rai = new Raices(8, 5, 2);
        RaicesServicios Rs = new RaicesServicios();

        Rs.getDiscriminante(Rai);
        Rs.tieneRaices(Rai);
        Rs.tieneRaiz(Rai);
