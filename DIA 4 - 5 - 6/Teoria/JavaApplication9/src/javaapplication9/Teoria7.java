/*
 ...
 trata del tipo de motor de una bomba para mover fluidos). Definir una variable tipoMotor y permitir que 
 el usuario ingrese un valor entre 1 y 4. El programa debe mostrar lo siguiente:
...
public class Teoria7 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ingresar que Motor (1-4)");
