...
public class EJERCICIO3 {
    ...
    public static void main(String[] args) {
        ...
        PrimeraOperacion.CrearOperacion();
        System.out.println("Suma: " + PrimeraOperacion.sumar());
        System.out.println("Resta: " + PrimeraOperacion.restar());
        System.out.println("Multiplicacion: " + PrimeraOperacion.multiplicar());
        System.out.println("division: " + PrimeraOperacion.dividir());
